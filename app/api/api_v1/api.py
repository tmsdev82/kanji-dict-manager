...
from app.api.api_v1.endpoints import kanji, compound_word, example_sentence, kanji_dict
...
api_router.include_router(kanji_dict.router, prefix="/kanji-dictionaries", tags=["kanji dictionaries"])